...
router.get('/blockshiftindata', async (req, res) => {
  try {
...
router.get('/blockshiftDataOut', async (req, res) => {
  try {
    const pool = await poolPromise;
    const shiftTimes = readShiftTimes();
    const { shiftNumber, shiftStart, shiftEnd } = getCurrentShift(shiftTimes);
...
router.get('/block_kickin', async (req, res) => {
  try {
    const pool = await poolPromise;
    const shiftTimes = readShiftTimes();
    const { shiftNumber, shiftStart, shiftEnd } = getCurrentShift(shiftTimes);
...
router.get('/block_kickout', async (req, res) => {
  try {
    const pool = await poolPromise;
    const shiftTimes = readShiftTimes();
    const { shiftNumber, shiftStart, shiftEnd } = getCurrentShift(shiftTimes);
...
router.get('/blockabnormalCycleData', async (req, res) => {
  try {
    const pool = await poolPromise;
    const shiftTimes = readShiftTimes();
    const { shiftNumber, shiftStart, shiftEnd } = getCurrentShift(shiftTimes);
