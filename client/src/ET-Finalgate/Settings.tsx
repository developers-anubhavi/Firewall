import '../ET-Finalgate/settings.css';
...
export default function Settings({ username, logout, usertype }: SettingsProps) {
    ...
    useEffect(() => {
        fetch('http://192.168.0.20:4001/api/et_shifts')
            .then(res => res.json())
            .then(data => {
                setShiftTimes(data);
    ...
    const handleUpdate = async () => {
        ...
        try {
            const res = await fetch('http://192.168.0.20:4001/api/et_update-shifts', {
                method: 'POST',
...
const [engineNumber, setEngineNumber] = useState("");
 ...
 const handleStationChange = (value: string) => { setSelectedStations(prev => prev.includes(value) ? prev.filter(x => x !== value) : [...prev, value] );
  ...
  setLoading(true); 
  try {
     const response = await fetch("http://192.168.0.20:4001/api/fetch-et-data", 
      { method: "POST",
         headers: { "Content-Type": "application/json" },
        ...
        a.href = url; a.download = "ET_FINAL_GATE_Report.xlsx"; 
    ...
    useEffect(() => {
        const fetchInitialData = async () => {
            try {
                const res = await fetch("http://192.168.0.20:4001/api/et_table-data");
    ...
    const handleSetTable = async () => {
        ...
        for (let i = 1; i <= 9; i++) {
            const c2 = parseFloat(document.getElementById(`et_col${i}_2`)?.innerText || "0");
            const c3 = parseFloat(document.getElementById(`et_col${i}_3`)?.innerText || "0");
            const c4 = parseFloat(document.getElementById(`et_col${i}_4`)?.innerText || "0");
        ...
        try {
            const res = await fetch("http://192.168.0.20:4001/api/et_update-table", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
       ...
       <div className="settings_modal">
         ...
         {/* <div className="settings">
           ...
           <tbody>
             ...
             <tr>
                 <td id='et_col1'>MACHINE</td>
                 <td id='et_col2'>2L</td>
                 <td id='et_col3'>1.5L</td>
                 <td id='et_col4'>+/-</td></tr>
             <tr>
                 <td id='et_col1_1'>Oil Leak</td>
                 <td id='et_col1_2'></td>
                 <td id='et_col1_3'></td>
                 <td id='et_col1_4'></td></tr>
             <tr>
                 <td id='et_col2_1'>Inj Moving</td>
                 <td id='et_col2_2'></td>
                 <td id='et_col2_3'></td>
                 <td id='et_col2_4'></td></tr>
             <tr>
                 <td id='et_col3_1'>Water Leak</td>
                 <td id='et_col3_2'></td>
                 <td id='et_col3_3'></td>
                 <td id='et_col3_4'></td></tr>
             <tr>
                 <td id='et_col4_1'>Oil Fill</td>
                 <td id='et_col4_2'></td>
                 <td id='et_col4_3'></td>
                 <td id='et_col4_4'></td></tr>
             <tr>
                 <td id='et_col5_1'>MTB-1</td>
                 <td id='et_col5_2'></td>
                 <td id='et_col5_3'></td>
                 <td id='et_col5_4'></td></tr>
             <tr>
                 <td id='et_col6_1'>MTB-2</td>
                 <td id='et_col6_2'></td>
                 <td id='et_col6_3'></td>
                 <td id='et_col6_4'></td></tr>
             <tr>
                 <td id='et_col7_1'>Final Label</td>
                 <td id='et_col7_2'></td>
                 <td id='et_col7_3'></td>
                 <td id='et_col7_4'></td></tr>
...
<div className="excel-container">
  <h1 className="excel-title">ET Final Gate - Excel Export</h1>
  ...
  <div className="et-engine-search">
