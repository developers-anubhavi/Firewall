...
export default function Settings({ username, logout, usertype }: SettingsProps) {
    ...
    useEffect(() => {
        fetch('http://192.168.0.20:4001/api/main_shifts')
            .then(res => res.json())
            .then(data => {
                setShiftTimes(data);
    ...
    const handleUpdate = async () => {
        ...
        try {
            const res = await fetch('http://192.168.0.20:4001/api/main_update-shifts', {
                method: 'POST',
...
const [engineNumber, setEngineNumber] = useState("");
 ...
 const handleStationChange = (value: string) => { setSelectedStations(prev => prev.includes(value) ? prev.filter(x => x !== value) : [...prev, value] );
  ...
  setLoading(true); 
  try {
     const response = await fetch("http://192.168.0.20:4001/api/fetch-mainline-data", 
      { method: "POST",
         headers: { "Content-Type": "application/json" },
        ...
        a.href = url; a.download = "MAINLINE_Report.xlsx"; 
    ...
    console.log("Updating table cells with:", data);
    Object.entries(data).forEach(([id, value]) => {
        const cell = document.getElementById(id);
        if (!cell) console.warn("Cell not found for ID:", id);
        if (cell) {
    ...
    useEffect(() => {
        const fetchInitialData = async () => {
            try {
                const res = await fetch("http://192.168.0.20:4001/api/main_table-data");
    ...
    const handleSetTable = async () => {
        ...
        for (let i = 1; i <= 13; i++) {
            const c2 = parseFloat(document.getElementById(`col${i}_2`)?.innerText || "0");
            const c3 = parseFloat(document.getElementById(`col${i}_3`)?.innerText || "0");
            const c4 = parseFloat(document.getElementById(`col${i}_4`)?.innerText || "0");
        ...
        try {
            const res = await fetch("http://192.168.0.20:4001/api/main_update-table", {
                method: "POST",
                headers: { "Content-Type": "application/json" },
       ...
       <div className="settings_modal">
         ...
         {/* <div className="settings">
           ...
           <tbody>
             ...
             <tr>
                 <td id='col1'>MACHINE</td>
                 <td id='col2'>2L</td>
                 <td id='col3'>1.5L</td>
                 <td id='col4'>+/-</td></tr>
             <tr>
                 <td id='col1_1'>R/O Seal NR</td>
                 <td id='col1_2'></td>
                 <td id='col1_3'></td>
                 <td id='col1_4'></td></tr>
             <tr>
                 <td id='col2_1'>Flywheel NR</td>
                 <td id='col2_2'></td>
                 <td id='col2_3'></td>
                 <td id='col2_4'></td></tr>
             <tr>
                 <td id='col3_1'>Head-bolt NR</td>
                 <td id='col3_2'></td>
                 <td id='col3_3'></td>
                 <td id='col3_4'></td></tr>
             <tr>
                 <td id='col4_1'>Cam-HSG NR</td>
                 <td id='col4_2'></td>
                 <td id='col4_3'></td>
                 <td id='col4_4'></td></tr>
             <tr>
                 <td id='col5_1'>TCC-1 NR</td>
                 <td id='col5_2'></td>
                 <td id='col5_3'></td>
                 <td id='col5_4'></td></tr>
             <tr>
                 <td id='col6_1'>TCC-2 NR</td>
                 <td id='col6_2'></td>
                 <td id='col6_3'></td>
                 <td id='col6_4'></td></tr>
             <tr>
                 <td id='col7_1'>Head cover</td>
                 <td id='col7_2'></td>
                 <td id='col7_3'></td>
                 <td id='col7_4'></td></tr>

              <tr>
                 <td id='col8_1'>oil pan FIPG</td>
                 <td id='col8_2'></td>
                 <td id='col8_3'></td>
                 <td id='col8_4'></td></tr>

              <tr>
                 <td id='col9_1'>Cam-HSG FIPG</td>
                 <td id='col9_2'></td>
                 <td id='col9_3'></td>
                 <td id='col9_4'></td></tr>

              <tr>
                 <td id='col10_1'>TCC-1 FIPG</td>
                 <td id='col10_2'></td>
                 <td id='col10_3'></td>
                 <td id='col10_4'></td></tr>

              <tr>
                 <td id='col11_1'>TCC-2 FIPG</td>
                 <td id='col11_2'></td>
                 <td id='col11_3'></td>
                 <td id='col11_4'></td></tr>

              <tr>
                 <td id='col12_1'>Rocker-Arm vision</td>
                 <td id='col12_2'></td>
                 <td id='col12_3'></td>
                 <td id='col12_4'></td></tr>

              <tr>
                 <td id='col13_1'>Spark-plug gap check</td>
                 <td id='col13_2'></td>
                 <td id='col13_3'></td>
                 <td id='col13_4'></td></tr>
...
<div className="excel-container">
  <h1 className="excel-title">MAINLINE - Excel Export</h1>
  ...
  <div className="main-engine-search">
  ...
  >
    {loading ? "Generating..." : "Download Excel"}
        ...
        <div className='main_shifttimings'>
          <table id='shifttext'>
