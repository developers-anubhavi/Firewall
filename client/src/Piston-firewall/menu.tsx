import '../Piston-firewall/menu.css';
...
const Menu: React.FC<MenuProps> = ({ setShowMenu }) => {
  ...
  return (
    <div
      className="piston_menu_overlay"
      onMouseEnter={() => setShowMenu(true)}    
      onMouseLeave={() => setShowMenu(false)}   
    >
      <div className="piston_menu_modal">

       {/* <div className="piston_menu_header">
          <span id="piston_menu_hf">Head Firewall</span>
           <span id="piston_menu_title">Menu</span>
        </div>  */}

        <div className="piston_menu_content">
          <ul>
