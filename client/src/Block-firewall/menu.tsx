import '../Block-firewall/menu.css';
...
const Menu: React.FC<MenuProps> = ({ setShowMenu }) => {
  ...
  return (
    <div
      className="block_menu_overlay"
      onMouseEnter={() => setShowMenu(true)}    
      onMouseLeave={() => setShowMenu(false)}   
    >
      <div className="block_menu_modal">

       {/* <div className="block_menu_header">
          <span id="block_menu_hf">Head Firewall</span>
           <span id="block_menu_title">Menu</span>
        </div>  */}

        <div className="block_menu_content">
          <ul>
